 ...
 //   private Float mCompareThres;
  ...
  //  private CameraPreviewData mCurrentImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musicId.put(8, soundPool.load(this, R.raw.moshengren, 1));//陌生人
    ...
    private class TanChuangThread extends Thread {
        ...
        public void run() {
            while (!isRing) {
                try {
                    //有动画 ，延迟到一秒一次
                    ZhiLingBean.DataBean commandsBean = linkedBlockingQueue.take();
                    if (paAccessControl == null) {
                        continue;
                    }
                    if (commandsBean.getOperationStatus()==1){//新增
                       ...
                       // Log.d("TanChuangThread", "subject:" + subject);
                        if (subject!=null){
                            continue;
                        }
